          ...
          'openPopup': function(feature) {
            ...
            if(feature.attributes.title) {
              ...
              for(var y = 0; y < feature.cluster.length; y++) {
                ...
                text += '<li>' + feature.cluster[y]['attributes']['title'] + '</li>';
              ...
              for(var y = 0; y < feature.cluster.length; y++) {
                ...
                text += '<li>' + feature.cluster[y]['attributes']['description'] + '</li>';
            ...
            'over' : function(feature) {
              ...
              if (!$('.openlayers-popupbox.popup', context).size()) {
                if (feature.attributes.name) {
                  ...
                  text += "<p>WMO Code: " + feature.cluster[0].attributes.field_station_number + "</p>";
                  text += "</div>";
                  context.append(text);
                }
              }
